...
STARTUP_SCRIPT="${ROOT}/server-bootstrap/scripts/server-start.sh"
BUNDLE_DIR="${ROOT}/server-bootstrap/assets/cfg"
...
[[ "$(realpath "${install_dir}/game/csgo/cfg/bhop.cfg")" == "$(realpath "${BUNDLE_DIR}/bhop.cfg")" ]]
[[ ! -e "${install_dir}/game/csgo/cfg/server-provided/live.cfg" ]]
